...
public class Chainer {
   ...
   * @param operation1 the first operation, it's a {@link Function} returning a {@link Future}, the
   *                   input is {@code input}.
   * @param operation2 the second operation, it's a {@link Function} returning a {@link Future}, the
   *                   input is the result of the first operation
   * @param <R>        the type of the final {@link Future}, so the type returned by the second
   *                   operation.
   * @param <A>        the input type
   * @param <B>        the intermediate type (output of the first operation, input of the second
   *                   one)
   * @return a future denoting the completion of the chain. If one of the operation fails, the
   * returned future is marked as failed.
   */
   ...
   * @param operation2 the second operation, it's a {@link Function} returning a {@link Future}, the
   *                   input is the result of the first operation
   * @param operation3 the second operation, it's a {@link Function} returning a {@link Future}, the
   *                   input is the result of the second operation
   * @param <R>        the type of the final {@link Future}, so the type returned by the second
   *                   operation.
   * @param <A>        the input type
   * @param <B>        the intermediate type (output of the first operation, input of the second
   *                   one)
   * @param <C>        the second intermediate type (output of the second operation, input of the
   *                   third one)
   * @return a future denoting the completion of the chain. If one of the operation fails, the
   * returned future is marked as failed.
   */
  ...
  /**
   * Chains the three given operations. The chain is executed when the input {@link Future} is
   * completed successfully. If the input {@link Future} is a failure, the chain is not executed,
   * and the return {@link Future} is makred as failed.
   *
  ...
  /**
   * Chains the two given operations. The chain is executed when the input {@link Future} is
   * completed successfully. If the input {@link Future} is a failure, the chain is not executed,
   * and the return {@link Future} is makred as failed.
   *
   * @param input      the {@link Future} triggering the chain on completion
